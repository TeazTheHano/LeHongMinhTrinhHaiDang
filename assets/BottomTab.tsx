...
import clrStyle, { defaultColorTheme, NGHIASTYLE } from './componentStyleSheet';
...
const COLORFOCUS = NGHIASTYLE.NghiaBrand700
const COLORNOTFOCUS = NGHIASTYLE.NghiaBrand400
...
const iconData: { page: any, icon: string, iconActive: string, title: string }[] = [
    {
        page: Home,
        iconActive: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
  <path d="M12 18V15" stroke="#B692F6" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
  <path d="M10.07 2.81985L3.14002 8.36985C2.36002 8.98985 1.86002 10.2998 2.03002 11.2798L3.36002 19.2398C3.60002 20.6598 4.96002 21.8098 6.40002 21.8098H17.6C19.03 21.8098 20.4 20.6498 20.64 19.2398L21.97 11.2798C22.13 10.2998 21.63 8.98985 20.86 8.36985L13.93 2.82985C12.86 1.96985 11.13 1.96985 10.07 2.81985Z" stroke="#B692F6" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
</svg>`,
        icon: `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M20.04 6.82006L14.28 2.79006C12.71 1.69006 10.3 1.75006 8.78999 2.92006L3.77999 6.83006C2.77999 7.61006 1.98999 9.21006 1.98999 10.4701V17.3701C1.98999 19.9201 4.05999 22.0001 6.60999 22.0001H17.39C19.94 22.0001 22.01 19.9301 22.01 17.3801V10.6001C22.01 9.25006 21.14 7.59006 20.04 6.82006ZM12.75 18.0001C12.75 18.4101 12.41 18.7501 12 18.7501C11.59 18.7501 11.25 18.4101 11.25 18.0001V15.0001C11.25 14.5901 11.59 14.2501 12 14.2501C12.41 14.2501 12.75 14.5901 12.75 15.0001V18.0001Z" fill=${NGHIASTYLE.NghiaBrand700}/></svg>`,
        title: 'Home'
    },
    {
        page: Test,
        iconActive: `<svg xmlns="http://www.w3.org/2000/svg" width="25" height="24" viewBox="0 0 25 24" fill="none">
  <path d="M12.7033 8.87988H17.9533" stroke="#B692F6" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
  <path d="M6.71332 8.87988L7.46332 9.62988L9.71332 7.37988" stroke="#B692F6" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
  <path d="M12.7033 15.8799H17.9533" stroke="#B692F6" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
  <path d="M6.71332 15.8799L7.46332 16.6299L9.71332 14.3799" stroke="#B692F6" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
  <path d="M9.33331 22H15.3333C20.3333 22 22.3333 20 22.3333 15V9C22.3333 4 20.3333 2 15.3333 2H9.33331C4.33331 2 2.33331 4 2.33331 9V15C2.33331 20 4.33331 22 9.33331 22Z" stroke="#B692F6" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
</svg>`,
        icon: `<svg xmlns="http://www.w3.org/2000/svg" width="25" height="24" viewBox="0 0 25 24" fill="none">
  <path d="M8.88976 13.4864L7.51211 14.8641C7.02341 14.5097 6.33748 14.5417 5.89274 14.9835C5.39363 15.4692 5.3935 16.2703 5.89237 16.7562L6.63452 17.4983C6.88365 17.7607 7.2214 17.87 7.52331 17.87C7.83877 17.87 8.15816 17.7523 8.40687 17.5036L10.6569 15.2536C11.1421 14.7683 11.1421 13.9717 10.6569 13.4864L10.6569 13.4864L10.6508 13.4805C10.1604 13.0064 9.37826 12.9979 8.88976 13.4864ZM8.88976 6.48645L7.51211 7.8641C7.02342 7.50969 6.3375 7.54165 5.89277 7.98345C5.39362 8.46919 5.3935 9.27029 5.89239 9.75618L6.63452 10.4983C6.88365 10.7607 7.2214 10.87 7.52331 10.87C7.83877 10.87 8.15816 10.7523 8.40687 10.5036L10.6569 8.25355C11.1421 7.76829 11.1421 6.97171 10.6569 6.48645L10.6569 6.4864L10.6508 6.48051C10.1604 6.00641 9.37826 5.99794 8.88976 6.48645ZM8.14331 2.5H16.5233C18.2439 2.5 19.5571 3.01093 20.4398 3.89355C21.3224 4.77618 21.8333 6.08944 21.8333 7.81V16.19C21.8333 17.9106 21.3224 19.2238 20.4398 20.1064C19.5571 20.9891 18.2439 21.5 16.5233 21.5H8.14331C6.42275 21.5 5.10949 20.9891 4.22687 20.1064C3.34424 19.2238 2.83331 17.9106 2.83331 16.19V7.81C2.83331 6.08944 3.34424 4.77618 4.22687 3.89355C5.10949 3.01093 6.42275 2.5 8.14331 2.5ZM12.6433 17.12H17.8933C18.5938 17.12 19.1433 16.5518 19.1433 15.87C19.1433 15.1882 18.5938 14.62 17.8933 14.62H12.6433C11.9572 14.62 11.3933 15.1839 11.3933 15.87C11.3933 16.5561 11.9572 17.12 12.6433 17.12ZM12.6433 10.12H17.8933C18.5938 10.12 19.1433 9.55179 19.1433 8.87C19.1433 8.18821 18.5938 7.62 17.8933 7.62H12.6433C11.9572 7.62 11.3933 8.18386 11.3933 8.87C11.3933 9.55614 11.9572 10.12 12.6433 10.12Z" fill="#6941C6" stroke="#6941C6"/>
</svg>`,
        title: 'Test'
    },
    // {
...
class RenderLabel extends Component<{ focused: boolean, title: string }, {}> {
    render(): React.ReactNode {
        return (
            ...
            <LABELTEXTCLASS style={{ color: this.props.focused ? COLORFOCUS : COLORNOTFOCUS } as TextStyle}>{this.props.title}</LABELTEXTCLASS>
        );
    }
}
