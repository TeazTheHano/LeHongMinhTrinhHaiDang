...
export const flashCardList: FORMATDATA.FlashCardFormat[] = [
    ...
    },
    {
        ...
        front: [
            ...
            `assets/photos/Flashcard/8/Dai So/3.1.png`,
            `assets/photos/Flashcard/8/Dai So/4.1.png`,
            `assets/photos/Flashcard/8/Dai So/5.1.png`,
            `assets/photos/Flashcard/8/Dai So/6.1.png`,
            `assets/photos/Flashcard/8/Dai So/7.1.png`,
            `assets/photos/Flashcard/8/Dai So/8.1.png`,
            `assets/photos/Flashcard/8/Dai So/9.1.png`,
            `assets/photos/Flashcard/8/Dai So/10.1.png`,
            `assets/photos/Flashcard/8/Dai So/11.1.png`,
            `assets/photos/Flashcard/8/Dai So/12.1.png`,
            `assets/photos/Flashcard/8/Dai So/13.1.png`,
            `assets/photos/Flashcard/8/Dai So/14.1.png`,
            `assets/photos/Flashcard/8/Dai So/15.1.png`,
        ],
        back: [
            `assets/photos/Flashcard/8/Dai So/1.2.png`,
            `assets/photos/Flashcard/8/Dai So/2.2.png`,
            `assets/photos/Flashcard/8/Dai So/3.2.png`,
            `assets/photos/Flashcard/8/Dai So/4.2.png`,
            `assets/photos/Flashcard/8/Dai So/5.2.png`,
            `assets/photos/Flashcard/8/Dai So/6.2.png`,
            `assets/photos/Flashcard/8/Dai So/7.2.png`,
            `assets/photos/Flashcard/8/Dai So/8.2.png`,
            `assets/photos/Flashcard/8/Dai So/9.2.png`,
            `assets/photos/Flashcard/8/Dai So/10.2.png`,
            `assets/photos/Flashcard/8/Dai So/11.2.png`,
            `assets/photos/Flashcard/8/Dai So/12.2.png`,
            `assets/photos/Flashcard/8/Dai So/13.2.png`,
            `assets/photos/Flashcard/8/Dai So/14.2.png`,
            `assets/photos/Flashcard/8/Dai So/15.2.png`,
        ]
    },
    {
        label: {
        ...
        front: [
            ...
            `assets/photos/Flashcard/8/Hinh Hoc/3.1.png`,
            `assets/photos/Flashcard/8/Hinh Hoc/4.1.png`,
            `assets/photos/Flashcard/8/Hinh Hoc/5.1.png`,
            `assets/photos/Flashcard/8/Hinh Hoc/6.1.png`,
            `assets/photos/Flashcard/8/Hinh Hoc/7.1.png`,
            `assets/photos/Flashcard/8/Hinh Hoc/8.1.png`,
            `assets/photos/Flashcard/8/Hinh Hoc/9.1.png`,
            `assets/photos/Flashcard/8/Hinh Hoc/10.1.png`,
            `assets/photos/Flashcard/8/Hinh Hoc/11.1.png`,
            `assets/photos/Flashcard/8/Hinh Hoc/12.1.png`,
            `assets/photos/Flashcard/8/Hinh Hoc/13.1.png`,
            `assets/photos/Flashcard/8/Hinh Hoc/14.1.png`,
            `assets/photos/Flashcard/8/Hinh Hoc/15.1.png`,
        ],
        back: [
            `assets/photos/Flashcard/8/Hinh Hoc/1.2.png`,
            `assets/photos/Flashcard/8/Hinh Hoc/2.2.png`,
            `assets/photos/Flashcard/8/Hinh Hoc/3.2.png`,
            `assets/photos/Flashcard/8/Hinh Hoc/4.2.png`,
            `assets/photos/Flashcard/8/Hinh Hoc/5.2.png`,
            `assets/photos/Flashcard/8/Hinh Hoc/6.2.png`,
            `assets/photos/Flashcard/8/Hinh Hoc/7.2.png`,
            `assets/photos/Flashcard/8/Hinh Hoc/8.2.png`,
            `assets/photos/Flashcard/8/Hinh Hoc/9.2.png`,
            `assets/photos/Flashcard/8/Hinh Hoc/10.2.png`,
            `assets/photos/Flashcard/8/Hinh Hoc/11.2.png`,
            `assets/photos/Flashcard/8/Hinh Hoc/12.2.png`,
            `assets/photos/Flashcard/8/Hinh Hoc/13.2.png`,
            `assets/photos/Flashcard/8/Hinh Hoc/14.2.png`,
            `assets/photos/Flashcard/8/Hinh Hoc/15.2.png`,
        ]
    },
    {
        label: {
        ...
        front: [
            ...
            `assets/photos/Flashcard/9/Dai So/3.1.png`,
            `assets/photos/Flashcard/9/Dai So/4.1.png`,
            `assets/photos/Flashcard/9/Dai So/5.1.png`,
            `assets/photos/Flashcard/9/Dai So/6.1.png`,
            `assets/photos/Flashcard/9/Dai So/7.1.png`,
            `assets/photos/Flashcard/9/Dai So/8.1.png`,
            `assets/photos/Flashcard/9/Dai So/9.1.png`,
            `assets/photos/Flashcard/9/Dai So/10.1.png`,
            `assets/photos/Flashcard/9/Dai So/11.1.png`,
            `assets/photos/Flashcard/9/Dai So/12.1.png`,
            `assets/photos/Flashcard/9/Dai So/13.1.png`,
            `assets/photos/Flashcard/9/Dai So/14.1.png`,
            `assets/photos/Flashcard/9/Dai So/15.1.png`,
        ],
        back: [
            `assets/photos/Flashcard/9/Dai So/1.2.png`,
            `assets/photos/Flashcard/9/Dai So/2.2.png`,
            `assets/photos/Flashcard/9/Dai So/3.2.png`,
            `assets/photos/Flashcard/9/Dai So/4.2.png`,
            `assets/photos/Flashcard/9/Dai So/5.2.png`,
            `assets/photos/Flashcard/9/Dai So/6.2.png`,
            `assets/photos/Flashcard/9/Dai So/7.2.png`,
            `assets/photos/Flashcard/9/Dai So/8.2.png`,
            `assets/photos/Flashcard/9/Dai So/9.2.png`,
            `assets/photos/Flashcard/9/Dai So/10.2.png`,
            `assets/photos/Flashcard/9/Dai So/11.2.png`,
            `assets/photos/Flashcard/9/Dai So/12.2.png`,
            `assets/photos/Flashcard/9/Dai So/13.2.png`,
            `assets/photos/Flashcard/9/Dai So/14.2.png`,
            `assets/photos/Flashcard/9/Dai So/15.2.png`,
        ]
    },
    {
        label: {
        ...
        front: [
            ...
            `assets/photos/Flashcard/9/Hinh Hoc/3.1 (2).png`,
            `assets/photos/Flashcard/9/Hinh Hoc/4.1 (2).png`,
            `assets/photos/Flashcard/9/Hinh Hoc/5.1 (2).png`,
            `assets/photos/Flashcard/9/Hinh Hoc/6.1 (2).png`,
            `assets/photos/Flashcard/9/Hinh Hoc/7.1 (2).png`,
            `assets/photos/Flashcard/9/Hinh Hoc/8.1 (2).png`,
            `assets/photos/Flashcard/9/Hinh Hoc/9.1 (2).png`,
            `assets/photos/Flashcard/9/Hinh Hoc/10.1 (2).png`,
        ],
        back: [
            `assets/photos/Flashcard/9/Hinh Hoc/1.2 (2).png`,
            `assets/photos/Flashcard/9/Hinh Hoc/2.2 (2).png`,
            `assets/photos/Flashcard/9/Hinh Hoc/3.2 (2).png`,
            `assets/photos/Flashcard/9/Hinh Hoc/4.2 (2).png`,
            `assets/photos/Flashcard/9/Hinh Hoc/5.2 (2).png`,
            `assets/photos/Flashcard/9/Hinh Hoc/6.2 (2).png`,
            `assets/photos/Flashcard/9/Hinh Hoc/7.2 (2).png`,
            `assets/photos/Flashcard/9/Hinh Hoc/8.2 (2).png`,
            `assets/photos/Flashcard/9/Hinh Hoc/9.2 (2).png`,
            `assets/photos/Flashcard/9/Hinh Hoc/10.2 (2).png`,
        ]
    }
]
